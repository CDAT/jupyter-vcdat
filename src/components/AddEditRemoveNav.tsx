        ...
        <div className="container-fluid">
          ...
          <NavItem>
            <NavLink
              ...
              title={this.props.addText ? this.props.addText : ""}
            >
              <i
                className={`glyphicon glyphicon-plus-sign ${
                  this.props.addAction ? "" : "disabled"
                }`}
              />
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink
              ...
              title={this.props.editText ? this.props.editText : ""}
            >
              <i className={`glyphicon glyphicon-edit disabled`} />
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink
              ...
              title={this.props.removeText ? this.props.removeText : ""}
            >
              <i className={`glyphicon glyphicon-remove-sign disabled`} />
            </NavLink>
          </NavItem>
        </div>
      </Nav>
