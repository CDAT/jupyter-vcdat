...
class TestVcdatPanel(BaseTestCase):
    ...
    def test_graphics_options(self):
        ...
        vcdat_panel.plot_type_group("boxfill").scroll_click()
        vcdat_panel.plot_type_group("scatter").scroll_click().sleep(1)
        vcdat_panel.plot_type_group("xvsy").scroll_click()
        vcdat_panel.plot_type_group("1d").scroll_click().sleep(1)
        vcdat_panel.plot_type_group("3d_dual_scalar").scroll_click()
        vcdat_panel.plot_type_group("3d_vector").scroll_click().sleep(1)
